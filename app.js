...
function setupEventListeners() {
  ...
  profilePicInput.addEventListener('change', (e) => {
    const file = e.target.files[0];
    if (file) {
      // Resize to 120x120px and compress to JPEG (70% quality)
      compressAndResizeImage(file, 120, 120, 0.7, (dataUrl) => {
...
const rtcConfig = {
  iceServers: [
    ...
    // Free public TURN/STUN servers from OpenRelayProject to traverse symmetric NATs / Firewalls
    {
